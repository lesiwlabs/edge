...
var targets = map[string]target{
	...
	"lesiw.io/boolset": &gopkg{
		pkg: "lesiw.io/boolset",
		src: "https://github.com/lesiw/boolset",
	},
	"lesiw.io/bump": &gopkg{
		app: "bump",
		pkg: "lesiw.io/bump",
	...
	"lesiw.io/checker": &gopkg{
		pkg: "lesiw.io/checker",
		src: "https://github.com/lesiw/checker",
	},
	...
	"lesiw.io/command": &gopkg{
		pkg: "lesiw.io/command",
		src: "https://github.com/lesiw/command",
	},
	...
	"lesiw.io/fs": &gopkg{
		pkg: "lesiw.io/fs",
		src: "https://github.com/lesiw/fs",
	},
	"lesiw.io/gorc": &gopkg{
		pkg: "lesiw.io/gorc",
		src: "https://github.com/lesiw/gorc",
	},
	...
	"lesiw.io/plscheck": &gopkg{
		pkg: "lesiw.io/plscheck",
		src: "https://github.com/lesiw/plscheck",
	},
	...
	"lesiw.io/step": &gopkg{
		pkg: "lesiw.io/step",
		src: "https://github.com/lesiw/step",
	},
	"lesiw.io/testcmp": &gopkg{
		pkg: "lesiw.io/testcmp",
		src: "https://github.com/lesiw/testcmp",
	},
	"lesiw.io/testhelpers": &gopkg{
		pkg: "lesiw.io/testhelpers",
		src: "https://github.com/lesiw/testhelpers",
	},
	"lesiw.io/testdetect": &gopkg{
		pkg: "lesiw.io/testdetect",
		src: "https://github.com/lesiw/testdetect",
	},
	"lesiw.io/tidytypes": &gopkg{
	...
	"lesiw.io/wait": &gopkg{
		pkg: "lesiw.io/wait",
		src: "https://github.com/lesiw/wait",
	},
	"lesiw.io/zeros": &gopkg{
		pkg: "lesiw.io/zeros",
		src: "https://github.com/lesiw/zeros",
	},
	"lesiw.io/zync": &gopkg{
		pkg: "lesiw.io/zync",
